...
public class Dashboard extends JFrame implements ActionListener{
    ...
    Dashboard(String username){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("travel/manage/system/icons/dashboard.jpg"));
        Image i5 = i4.getImage().getScaledInstance(70, 70, Image.SCALE_DEFAULT);
        ImageIcon i6 = new ImageIcon(i5);
        JLabel l2 = new JLabel(i6);
        l2.setBounds(10, 2, 60, 60);
        p1.add(l2);
       ...
       b14 = new JButton("Notepad");
        ...
        b14.setMargin(new Insets(0,0,0,160));
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/manage/system/icons/home.jpg"));
