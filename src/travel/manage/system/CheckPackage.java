...
public class CheckPackage extends JFrame {
    CheckPackage(){
        ...
        String[] package3 = new String[]{"BRONZE PACKAGE","4 Days and 3 Nights","Return Airfare","FreeClubbing,HorseRiding&Other Games","Welcome Drinks on Arrival","Daily Buffet ","Stay in 5 Star Hotel","BBQ Dinner","Book Now","WINTER SPECIAL","Rs 32000/-","package3.jpg"};
    ...
    p1.add(l11);
     ...
     ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/manage/system/icons/"+pack[11]));
