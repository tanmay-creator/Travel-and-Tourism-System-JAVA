...
public class Login extends JFrame  implements ActionListener{
    ...
    Login(){
        ...
        p1.setLayout(null);
        add(p1);
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/manage/system/icons/login.png"));
        ...
        b2.setBorder(new LineBorder(new Color(113,193,233)));
        ...
        b3.setBorder(new LineBorder(new Color(113,193,233)));
