...
public class ViewBookedHotel extends JFrame implements ActionListener {
    ...
    ViewBookedHotel(String username){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/manage/system/icons/bookedDetails.jpg"));
        ...
        try{
          Conn c = new Conn();
          ResultSet rs = c.s.executeQuery("select * from bookhotel where username = 'tanmay'");
          while(rs.next()){
              l11.setText(rs.getString(1));//instead of coloum name we can also write coloum number.
